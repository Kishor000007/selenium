...
//program to print all the woodland shoe prices of the search result of Flipkart in the sorting order
public class SortingPriceOfShoes{
	...
	public static void main(String[] args) throws InterruptedException {
		 //sets the path for chromrdriver.exe//
	       ...
	       //sorts the lists based on the price
	       Collections.sort(al,new shoepricecomparator());
